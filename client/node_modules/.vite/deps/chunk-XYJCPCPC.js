...
// ../node_modules/mermaid/dist/chunks/mermaid.esm/chunk-6PHMZWEM.mjs
...
var Theme = (_a4 = class {
  ...
  updateColors() {
    ...
    this.radar = {
      axisColor: ((_a10 = this.radar) == null ? void 0 : _a10.axisColor) || this.lineColor,
...
var Theme2 = (_a5 = class {
  ...
  updateColors() {
    ...
    this.quadrantTitleFill = this.quadrantTitleFill || this.primaryTextColor;
    this.xyChart = {
      backgroundColor: ((_a10 = this.xyChart) == null ? void 0 : _a10.backgroundColor) || this.background,
...
var addDirective = __name((directive) => {
  ...
  if (directive.fontFamily && !((_a10 = directive.themeVariables) == null ? void 0 : _a10.fontFamily)) {
...
var sanitizeMore = __name((text2, config2) => {
  var _a10;
  if (((_a10 = config2.flowchart) == null ? void 0 : _a10.htmlLabels) !== false) {
...
var hasKatex = __name((text2) => {
  var _a10;
  return (((_a10 = text2.match(katexRegex)) == null ? void 0 : _a10.length) ?? 0) > 0;
}, "hasKatex");
...
var renderKatexUnsanitized = __name(async (text2, config2) => {
  ...
  if (true) {
    const { default: katex } = await import("./katex-A6QSACVP-ITNL4FOJ.js");
...
var registerDiagram = __name((id, diagram, detector) => {
  ...
  (_a10 = diagram.injectUtils) == null ? void 0 : _a10.call(
    diagram,
    log2,
    setLogLevel2,
    getConfig2,
...
mermaid/dist/chunks/mermaid.esm/chunk-6PHMZWEM.mjs:
  (*! Bundled license information:
  ...
  *)
*/
//# sourceMappingURL=chunk-XYJCPCPC.js.map
