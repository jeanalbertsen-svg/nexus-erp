...
// ../node_modules/mermaid/dist/chunks/mermaid.esm/chunk-4RZPZ3GF.mjs
...
function V(l3, e) {
  ...
  if (n[0].trim() || n.shift(), n.length > 0 && !((_a8 = n.at(-1)) == null ? void 0 : _a8.trim()) && n.pop(), e) if (n.length > e) n.splice(e);
...
`, e = e.substring(Z.length + 1), f = A.slice(g);
  ...
  table(e) {
    ...
    let n = V(t[1]), r = t[2].replace(this.rules.other.tableAlignChars, "").split("|"), i = ((_a8 = t[3]) == null ? void 0 : _a8.trim()) ? t[3].replace(this.rules.other.tableRowBlankLine, "").split(`
  ...
  url(e) {
    ...
    if (t = this.rules.inline.url.exec(e)) {
      ...
      if (t[2] === "@") n = t[0], r = "mailto:" + n;
        ...
        let i;
        do
          i = t[0], t[0] = ((_a8 = this.rules.inline._backpedal.exec(t[0])) == null ? void 0 : _a8[0]) ?? "";
        while (i !== t[0]);
...
`), this.blockTokens(e, this.tokens);
  ...
  blockTokens(e, t = [], n = false) {
    ...
    for (this.options.pedantic && (e = e.replace(m.tabCharGlobal, "    ").replace(m.spaceLine, "")); e; ) {
      let r;
      if ((_b = (_a8 = this.options.extensions) == null ? void 0 : _a8.block) == null ? void 0 : _b.some((s) => (r = s.call({ lexer: this }, e, t)) ? (e = e.substring(r.raw.length), t.push(r), true) : false)) continue;
...
` + r.text, this.inlineQueue.pop(), this.inlineQueue.at(-1).src = s.text) : t.push(r);
  ...
  inlineTokens(e, t = []) {
    ...
    n = ((_b = (_a8 = this.options.hooks) == null ? void 0 : _a8.emStrongMask) == null ? void 0 : _b.call({ lexer: this }, n)) ?? n;
    let i = false, s = "";
    for (; e; ) {
      i || (s = ""), i = false;
      let o;
...
var P = (_a3 = class {
  ...
  code({ text: e, lang: t, escaped: n }) {
    var _a8;
    let r = (_a8 = (t || "").match(m.notSpaceStart)) == null ? void 0 : _a8[0], i = e.replace(m.endingNewline, "") + `
`;
...
`;
  ...
  listitem(e) {
    ...
    if (e.task) {
      ...
      e.loose ? ((_a8 = e.tokens[0]) == null ? void 0 : _a8.type) === "paragraph" ? (e.tokens[0].text = n + " " + e.tokens[0].text, e.tokens[0].tokens && e.tokens[0].tokens.length > 0 && e.tokens[0].tokens[0].type === "text" && (e.tokens[0].tokens[0].text = n + " " + w(e.tokens[0].tokens[0].text), e.tokens[0].tokens[0].escaped = true)) : e.tokens.unshift({ type: "text", raw: n + " ", text: n + " ", escaped: true }) : t += n + " ";
    }
...
var R = (_a5 = class {
  ...
  parse(e, t = true) {
    ...
    for (let r = 0; r < e.length; r++) {
      let i = e[r];
      if ((_b = (_a8 = this.options.extensions) == null ? void 0 : _a8.renderers) == null ? void 0 : _b[i.type]) {
...
var B = (_a7 = class {
  ...
  walkTokens(e, t) {
    ...
    for (let r of e) switch (n = n.concat(t.call(this, r)), r.type) {
      ...
      default: {
        let i = r;
        ((_b = (_a8 = this.defaults.extensions) == null ? void 0 : _a8.childTokens) == null ? void 0 : _b[i.type]) ? this.defaults.extensions.childTokens[i.type].forEach((s) => {
          let o = i[s].flat(1 / 0);
...
function markdownToLines(markdown, config = {}) {
  ...
  nodes.forEach((treeNode) => {
    ...
    if (treeNode.type === "paragraph") {
      (_a8 = treeNode.tokens) == null ? void 0 : _a8.forEach((contentNode) => {
...
function markdownToHTML(markdown, { markdownAutoWrap } = {}) {
  ...
  function output(node) {
    ...
    if (node.type === "text") {
      ...
      return `<strong>${(_a8 = node.tokens) == null ? void 0 : _a8.map(output).join("")}</strong>`;
...
function computeDimensionOfText(parentNode, lineHeight, text) {
  ...
  const textDimension = (_a8 = testSpan.node()) == null ? void 0 : _a8.getBoundingClientRect();
  if (textDimension) {
    testElement.remove();
  }
...
//# sourceMappingURL=chunk-ZHYR3FD7.js.map
