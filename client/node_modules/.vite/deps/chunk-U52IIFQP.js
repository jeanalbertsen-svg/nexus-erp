...
} from "./chunk-E5RTLVIC.js";
import {
  compileStyles,
  solidStateFill,
  styles2String,
  userNodeOverrides
} from "./chunk-52JBIFQ6.js";
import {
  createText,
  getIconSVG
...
// ../node_modules/mermaid/dist/chunks/mermaid.esm/chunk-ZRZ2AMKI.mjs
var labelHelper = __name(async (parent, node, _classes) => {
  var _a11, _b;
  let cssClasses;
  const useHtmlLabels = node.useHtmlLabels || evaluate((_a11 = getConfig2()) == null ? void 0 : _a11.htmlLabels);
  if (!_classes) {
...
var insertLabel = __name(async (parent, label, options) => {
  ...
  const useHtmlLabels = options.useHtmlLabels || evaluate((_b = (_a11 = getConfig2()) == null ? void 0 : _a11.flowchart) == null ? void 0 : _b.htmlLabels);
...
async function doublecircle(parent, node) {
  ...
  if (node.look === "handDrawn") {
    ...
    (_a11 = circleGroup.node()) == null ? void 0 : _a11.appendChild(outerRoughNode);
...
async function note(parent, node, { config: { themeVariables } }) {
  ...
  const { labelStyles, nodeStyles } = styles2String(node);
  node.labelStyle = labelStyles;
  const useHtmlLabels = node.useHtmlLabels || ((_a11 = getConfig().flowchart) == null ? void 0 : _a11.htmlLabels) !== false;
  if (!useHtmlLabels) {
...
async function rectWithTitle(parent, node) {
  ...
  if (evaluate((_b = (_a11 = getConfig2()) == null ? void 0 : _a11.flowchart) == null ? void 0 : _b.htmlLabels)) {
...
async function triangle(parent, node) {
  ...
  node.labelStyle = labelStyles;
  const { shapeSvg, bbox, label } = await labelHelper(parent, node, getNodeClasses(node));
  const useHtmlLabels = evaluate((_a11 = getConfig2().flowchart) == null ? void 0 : _a11.htmlLabels);
  const w2 = bbox.width + (node.padding ?? 0);
  const h2 = w2 + bbox.height;
  const tw = w2 + bbox.height;
  const points = [
...
async function erBox(parent, node) {
  ...
  let PADDING = ((_a11 = config.er) == null ? void 0 : _a11.diagramPadding) ?? 10;
        ...
        [...images].map(
          (img) => new Promise((res) => {
            function setupImage() {
              ...
              img.style.flexDirection = "column";
              if (noImgText) {
                const bodyFontSize = ((_a11 = config.fontSize) == null ? void 0 : _a11.toString()) ?? window.getComputedStyle(document.body).fontSize;
                const enlargingFactor = 5;
...
async function classBox(parent, node) {
  ...
  const styles = ((_a11 = classNode.styles) == null ? void 0 : _a11.join(";")) || nodeStyles || "";
  if (!node.cssStyles) {
  ...
  shapeSvg.selectAll(".text").each((_2, i2, nodes) => {
    ...
    if (text2.attr("class").includes("label-group") || text2.attr("class").includes("annotation-group")) {
      newTranslateX = -((_a12 = text2.node()) == null ? void 0 : _a12.getBBox().width) / 2 || 0;
...
async function requirementBox(parent, node) {
  ...
  const totalWidth = (((_a11 = shapeSvg.node()) == null ? void 0 : _a11.getBBox().width) ?? 200) + padding;
...
async function kanbanItem(parent, kanbanNode, { config }) {
  ...
  let ticketUrl = "";
  let link;
  if ("ticket" in kanbanNode && kanbanNode.ticket && ((_a11 = config == null ? void 0 : config.kanban) == null ? void 0 : _a11.ticketBaseUrl)) {
...
//# sourceMappingURL=chunk-U52IIFQP.js.map
