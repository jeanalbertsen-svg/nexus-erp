import {
  package_default
} from "./chunk-JTKWVXPR.js";
import {
  selectSvgElement
} from "./chunk-KHXEPYOB.js";
import {
  JSON_SCHEMA,
  load
} from "./chunk-W2DIPKDW.js";
import {
  registerLayoutLoaders
} from "./chunk-QCRE2L2J.js";
import "./chunk-DZRWVUMJ.js";
import "./chunk-FG4HJYA7.js";
import "./chunk-U52IIFQP.js";
import "./chunk-E5RTLVIC.js";
import "./chunk-52JBIFQ6.js";
import {
  dedent,
  registerIconPacks
} from "./chunk-ZHYR3FD7.js";
import {
  cleanAndMerge,
  decodeEntities,
  encodeEntities,
  ...
  removeDirectives,
  utils_default
} from "./chunk-JGGAK2XG.js";
import "./chunk-KZJUOV5S.js";
import {
  UnknownDiagramError,
  addDirective,
  ...
  themes_default,
  updateSiteConfig
} from "./chunk-XYJCPCPC.js";
import {
  log,
  select_default2,
  setLogLevel
} from "./chunk-QVUVRO7Y.js";
import {
  isEmpty_default
} from "./chunk-BWEAO62J.js";
import "./chunk-IE3XZ2XK.js";
import {
  __name
...
var loader = __name(async () => {
  const { diagram: diagram2 } = await import("./c4Diagram-3CMHLY2Z-56T47TP3.js");
...
var loader2 = __name(async () => {
  const { diagram: diagram2 } = await import("./flowDiagram-LRCQ345D-RKNJGJHJ.js");
...
var loader4 = __name(async () => {
  const { diagram: diagram2 } = await import("./erDiagram-ZP4OFZ4B-MA3G6OTD.js");
...
var loader5 = __name(async () => {
  const { diagram: diagram2 } = await import("./gitGraphDiagram-HMYFBHNQ-CSKV7NS6.js");
...
var loader6 = __name(async () => {
  const { diagram: diagram2 } = await import("./ganttDiagram-VJPWFMMQ-QXO3NDYD.js");
...
var loader7 = __name(async () => {
  const { diagram: diagram2 } = await import("./infoDiagram-I6REF7IB-PDCPFMTU.js");
...
var loader8 = __name(async () => {
  const { diagram: diagram2 } = await import("./pieDiagram-DMORWRXK-7GTP26ST.js");
...
var loader9 = __name(async () => {
  const { diagram: diagram2 } = await import("./quadrantDiagram-Q67ROWKZ-6TIWKKPX.js");
...
var loader10 = __name(async () => {
  const { diagram: diagram2 } = await import("./xychartDiagram-SWH7VB4X-5UJMEZ7T.js");
...
var loader11 = __name(async () => {
  const { diagram: diagram2 } = await import("./requirementDiagram-4IVVUT3F-LECDR23S.js");
...
var loader12 = __name(async () => {
  const { diagram: diagram2 } = await import("./sequenceDiagram-MB3FELIF-QJ5RYQ3Y.js");
...
var loader13 = __name(async () => {
  const { diagram: diagram2 } = await import("./classDiagram-REIJRMC6-B3KB6LJ6.js");
...
var loader14 = __name(async () => {
  const { diagram: diagram2 } = await import("./classDiagram-v2-HZ55VHUP-G2PH5YHF.js");
...
var loader15 = __name(async () => {
  const { diagram: diagram2 } = await import("./stateDiagram-J2IEDMT6-6DX73H3C.js");
...
var loader16 = __name(async () => {
  const { diagram: diagram2 } = await import("./stateDiagram-v2-ETO7MZ7O-D5SMZC2L.js");
...
var loader17 = __name(async () => {
  const { diagram: diagram2 } = await import("./journeyDiagram-EMBJJZIB-D5B3BOTD.js");
...
var loader19 = __name(async () => {
  const { diagram: diagram2 } = await import("./timeline-definition-IBICBATI-LPHY3VXA.js");
...
var loader20 = __name(async () => {
  const { diagram: diagram2 } = await import("./mindmap-definition-6J2R6LHS-2CR5BVOR.js");
...
var loader21 = __name(async () => {
  const { diagram: diagram2 } = await import("./kanban-definition-XZ6RF72J-LN7FD3EX.js");
...
var loader22 = __name(async () => {
  const { diagram: diagram2 } = await import("./sankeyDiagram-OLRELTUB-VIWNCOLE.js");
...
var loader23 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-TKFVDK6Q-YYQW3V3H.js");
...
var loader24 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-MACBZWK3-TD7QPNCI.js");
...
var loader25 = __name(async () => {
  const { diagram: diagram2 } = await import("./blockDiagram-NX637PPV-HJ7UXEU5.js");
...
var loader26 = __name(async () => {
  const { diagram: diagram2 } = await import("./architectureDiagram-X5VOOHYO-CQHRH7FH.js");
...
var loader27 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-35RNQRIT-QX3EI6RK.js");
